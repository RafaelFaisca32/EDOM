...
/**
 * This is the item provider adapter for a {@link isep.assignment2.cr2.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Cr2Package.Literals.PROJECT__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Project_version_feature",
								"_UI_Project_type"),
						Cr2Package.Literals.PROJECT__VERSION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Cr2Package.Literals.PROJECT__TARGET);
			childrenFeatures.add(Cr2Package.Literals.PROJECT__TASKS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(Cr2Package.Literals.PROJECT__TARGET, Cr2Factory.eINSTANCE.createTarget()));

		newChildDescriptors
				.add(createChildParameter(Cr2Package.Literals.PROJECT__TASKS, Cr2Factory.eINSTANCE.createTask()));
	}
