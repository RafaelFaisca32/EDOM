...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/acceleo/sirius/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(isep.assignment2.cr2.Cr2Package.class)) {
            resourceSet.getPackageRegistry().put(isep.assignment2.cr2.Cr2Package.eINSTANCE.getNsURI(), isep.assignment2.cr2.Cr2Package.eINSTANCE);
        }
