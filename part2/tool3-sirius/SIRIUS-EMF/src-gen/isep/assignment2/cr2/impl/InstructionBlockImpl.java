 ...
 * </p>
 * <ul>
 *   <li>{@link isep.assignment2.cr2.impl.InstructionBlockImpl#getHas <em>Has</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstructionBlockImpl extends ActionImpl implements InstructionBlock {
	...
	protected EClass eStaticClass() {
		return Cr2Package.Literals.INSTRUCTION_BLOCK;
	}
	...
	public EList<Instruction> getHas() {
		if (has == null) {
			has = new EObjectContainmentEList<Instruction>(Instruction.class, this, Cr2Package.INSTRUCTION_BLOCK__HAS);
		}
		return has;
	}
