...
import isep.assignment2.cr2.util.Cr2Validator;
...
public class Cr2PackageImpl extends EPackageImpl implements Cr2Package {
	 ...
	 * @see isep.assignment2.cr2.Cr2Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getTarget_Input() {
	 ...
	 * @generated
	 */
	public EReference getDecision_Condition() {
	...
	public void createPackageContents() {
		...
		createEReference(targetEClass, TARGET__INPUT);
		...
		createEReference(decisionEClass, DECISION__CONDITION);
	...
	public void initializePackageContents() {
		...
		instructionBlockEClass.getESuperTypes().add(this.getAction());
		...
		initEReference(getTarget_Input(), this.getFile(), null, "input", null, 1, 1, Target.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEAttribute(getTask_Description(), ecorePackage.getEString(), "description", null, 0, 1, Task.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTask_Has(), this.getProperty(), null, "has", null, 0, -1, Task.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEReference(getDecision_Has(), this.getProperty(), null, "has", null, 0, -1, Decision.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getDecision_Condition(), this.getCondition(), null, "condition", null, 1, -1, Decision.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation(this, source,
				new String[] { "invocationDelegates", "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
						...
						"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot" });
		addAnnotation(projectEClass, source, new String[] { "constraints", "mustHaveName mustHaveVersion" });
		addAnnotation(targetEClass, source, new String[] { "constraints", "nameMustStartWithUppercase" });
		addAnnotation(taskEClass, source,
				new String[] { "constraints", "mustHaveName nameMustBeUnique nameMustStartWithUppercase" });
		addAnnotation(fileEClass, source, new String[] { "constraints", "mustHaveName" });
		addAnnotation(propertyEClass, source, new String[] { "constraints",
				"mustHaveName mustHaveValue nameMustBeUnique nameMustStartWithUppercase" });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation(projectEClass, source, new String[] { "mustHaveName", "not self.name.oclIsUndefined()",
				"mustHaveVersion", "not self.version.oclIsUndefined()" });
		addAnnotation(targetEClass, source, new String[] { "nameMustStartWithUppercase",
				"self.name.substring(1,1).toUpper().compareTo(self.name.substring(1,1))=0" });
		addAnnotation(taskEClass, source,
				new String[] { "mustHaveName", "not self.name.oclIsUndefined()", "nameMustBeUnique",
						"Task.allInstances()->isUnique(e | e.name)", "nameMustStartWithUppercase",
						"self.name.substring(1,1).toUpper().compareTo(self.name.substring(1,1))=0" });
		addAnnotation(fileEClass, source, new String[] { "mustHaveName", "not self.name.oclIsUndefined()" });
		addAnnotation(propertyEClass, source,
				new String[] { "mustHaveName", "not self.name.oclIsUndefined()", "mustHaveValue",
						"not self.value.oclIsUndefined()", "nameMustBeUnique",
						"Property.allInstances()->isUnique(e | e.name)", "nameMustStartWithUppercase",
						"self.name.substring(1,1).toUpper().compareTo(self.name.substring(1,1))=0" });
	}
