 ...
 * </p>
 * <ul>
 *   <li>{@link sirius.assignment.cr2.impl.FileImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FileImpl extends MinimalEObjectImpl.Container implements File {
	...
	public boolean mustHaveName(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "File::mustHaveName";
		try {
			/**
			 *
			 * inv mustHaveName:
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					Cr2Package.Literals.FILE___MUST_HAVE_NAME__DIAGNOSTICCHAIN_MAP);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case Cr2Package.FILE___MUST_HAVE_NAME__DIAGNOSTICCHAIN_MAP:
