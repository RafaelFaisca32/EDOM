...
/**
 * This is the item provider adapter for a {@link sirius.assignment.cr2.Property} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Property_name_feature",
								"_UI_Property_type"),
						Cr2Package.Literals.PROPERTY__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Property_value_feature",
								"_UI_Property_type"),
						Cr2Package.Literals.PROPERTY__VALUE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addHasPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Property_has_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Property_has_feature",
								"_UI_Property_type"),
						Cr2Package.Literals.PROPERTY__HAS, true, false, true, null, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case Cr2Package.PROPERTY__NAME:
		case Cr2Package.PROPERTY__VALUE:
