 ...
 * from:
 *   /pt.isep.edom.assignment1/model/assignment1.ecore
 * using:
 *   /pt.isep.edom.assignment1/model/assignment1.genmodel
...
// import pt.isep.edom.assignment1.Assignment1Tables;

/**
 * Assignment1Tables provides the dispatch tables for the assignment1 for use by the OCL dispatcher.
 *
 * In order to ensure correct static initialization, a top level class element must be accessed
 * before any nested class element. Therefore an access to PACKAGE.getClass() is recommended.
 */
public class Assignment1Tables extends AbstractTables
{
	static {
		Init.initStart();
	}
	 ...
	 */
	public static final EcoreExecutorPackage PACKAGE = new EcoreExecutorPackage(Assignment1Package.eINSTANCE);
	...
	public static final /*@NonInvalid*/ NsURIPackageId PACKid_http_c_s_s_www_example_org_s_assignment1 = IdManager.getNsURIPackageId("http://www.example.org/assignment1", null, Assignment1Package.eINSTANCE);
	public static final /*@NonInvalid*/ ClassId CLSSid_Action = Assignment1Tables.PACKid_http_c_s_s_www_example_org_s_assignment1.getClassId("Action", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Class = Assignment1Tables.PACKid_$metamodel$.getClassId("Class", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Condition = Assignment1Tables.PACKid_http_c_s_s_www_example_org_s_assignment1.getClassId("Condition", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Decision = Assignment1Tables.PACKid_http_c_s_s_www_example_org_s_assignment1.getClassId("Decision", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_File = Assignment1Tables.PACKid_http_c_s_s_www_example_org_s_assignment1.getClassId("File", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_FileTarget = Assignment1Tables.PACKid_http_c_s_s_www_example_org_s_assignment1.getClassId("FileTarget", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_IfDecision = Assignment1Tables.PACKid_http_c_s_s_www_example_org_s_assignment1.getClassId("IfDecision", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Instruction = Assignment1Tables.PACKid_http_c_s_s_www_example_org_s_assignment1.getClassId("Instruction", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_InstructionBlock = Assignment1Tables.PACKid_http_c_s_s_www_example_org_s_assignment1.getClassId("InstructionBlock", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Model = Assignment1Tables.PACKid_http_c_s_s_www_example_org_s_assignment1.getClassId("Model", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Project = Assignment1Tables.PACKid_http_c_s_s_www_example_org_s_assignment1.getClassId("Project", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Property = Assignment1Tables.PACKid_http_c_s_s_www_example_org_s_assignment1.getClassId("Property", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Start = Assignment1Tables.PACKid_http_c_s_s_www_example_org_s_assignment1.getClassId("Start", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Target = Assignment1Tables.PACKid_http_c_s_s_www_example_org_s_assignment1.getClassId("Target", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Task = Assignment1Tables.PACKid_http_c_s_s_www_example_org_s_assignment1.getClassId("Task", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_WhileDecision = Assignment1Tables.PACKid_http_c_s_s_www_example_org_s_assignment1.getClassId("WhileDecision", 0);
	public static final /*@NonInvalid*/ IntegerValue INT_0 = ValueUtil.integerValueOf("0");
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_FileTarget = TypeId.BAG.getSpecializedId(Assignment1Tables.CLSSid_FileTarget);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_IfDecision = TypeId.BAG.getSpecializedId(Assignment1Tables.CLSSid_IfDecision);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_Property = TypeId.BAG.getSpecializedId(Assignment1Tables.CLSSid_Property);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_Start = TypeId.BAG.getSpecializedId(Assignment1Tables.CLSSid_Start);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_Target = TypeId.BAG.getSpecializedId(Assignment1Tables.CLSSid_Target);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_Task = TypeId.BAG.getSpecializedId(Assignment1Tables.CLSSid_Task);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Action = TypeId.ORDERED_SET.getSpecializedId(Assignment1Tables.CLSSid_Action);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Condition = TypeId.ORDERED_SET.getSpecializedId(Assignment1Tables.CLSSid_Condition);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Decision = TypeId.ORDERED_SET.getSpecializedId(Assignment1Tables.CLSSid_Decision);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_IfDecision = TypeId.ORDERED_SET.getSpecializedId(Assignment1Tables.CLSSid_IfDecision);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Instruction = TypeId.ORDERED_SET.getSpecializedId(Assignment1Tables.CLSSid_Instruction);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_InstructionBlock = TypeId.ORDERED_SET.getSpecializedId(Assignment1Tables.CLSSid_InstructionBlock);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Property = TypeId.ORDERED_SET.getSpecializedId(Assignment1Tables.CLSSid_Property);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Target = TypeId.ORDERED_SET.getSpecializedId(Assignment1Tables.CLSSid_Target);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Task = TypeId.ORDERED_SET.getSpecializedId(Assignment1Tables.CLSSid_Task);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_WhileDecision = TypeId.ORDERED_SET.getSpecializedId(Assignment1Tables.CLSSid_WhileDecision);
	public static final /*@NonInvalid*/ CollectionTypeId SET_CLSSid_Property = TypeId.SET.getSpecializedId(Assignment1Tables.CLSSid_Property);
	public static final /*@NonInvalid*/ CollectionTypeId SET_CLSSid_Task = TypeId.SET.getSpecializedId(Assignment1Tables.CLSSid_Task);
	...
	public static class TypeParameters {
		...
		/**
		 * Force initialization of the fields of Assignment1Tables::TypeParameters and all preceding sub-packages.
		 */
	...
	public static class Types {
		...
		public static final EcoreExecutorType _Action = new EcoreExecutorType(Assignment1Package.Literals.ACTION, PACKAGE, 0);
		public static final EcoreExecutorType _ClosureBackedAction = new EcoreExecutorType(Assignment1Package.Literals.CLOSURE_BACKED_ACTION, PACKAGE, 0);
		public static final EcoreExecutorType _Condition = new EcoreExecutorType(Assignment1Package.Literals.CONDITION, PACKAGE, 0);
		public static final EcoreExecutorType _CustomAction = new EcoreExecutorType(Assignment1Package.Literals.CUSTOM_ACTION, PACKAGE, 0);
		public static final EcoreExecutorType _Decision = new EcoreExecutorType(Assignment1Package.Literals.DECISION, PACKAGE, 0);
		public static final EcoreExecutorType _DefaultAction = new EcoreExecutorType(Assignment1Package.Literals.DEFAULT_ACTION, PACKAGE, 0);
		public static final EcoreExecutorType _End = new EcoreExecutorType(Assignment1Package.Literals.END, PACKAGE, 0);
		public static final EcoreExecutorType _File = new EcoreExecutorType(Assignment1Package.Literals.FILE, PACKAGE, 0);
		public static final EcoreExecutorType _FileTarget = new EcoreExecutorType(Assignment1Package.Literals.FILE_TARGET, PACKAGE, 0);
		public static final EcoreExecutorType _IfDecision = new EcoreExecutorType(Assignment1Package.Literals.IF_DECISION, PACKAGE, 0);
		public static final EcoreExecutorType _Instruction = new EcoreExecutorType(Assignment1Package.Literals.INSTRUCTION, PACKAGE, 0);
		public static final EcoreExecutorType _InstructionBlock = new EcoreExecutorType(Assignment1Package.Literals.INSTRUCTION_BLOCK, PACKAGE, 0);
		public static final EcoreExecutorType _LoopDecision = new EcoreExecutorType(Assignment1Package.Literals.LOOP_DECISION, PACKAGE, 0);
		public static final EcoreExecutorType _Model = new EcoreExecutorType(Assignment1Package.Literals.MODEL, PACKAGE, 0);
		public static final EcoreExecutorType _Project = new EcoreExecutorType(Assignment1Package.Literals.PROJECT, PACKAGE, 0);
		public static final EcoreExecutorType _Property = new EcoreExecutorType(Assignment1Package.Literals.PROPERTY, PACKAGE, 0);
		public static final EcoreExecutorType _Start = new EcoreExecutorType(Assignment1Package.Literals.START, PACKAGE, 0);
		public static final EcoreExecutorType _Target = new EcoreExecutorType(Assignment1Package.Literals.TARGET, PACKAGE, 0);
		public static final EcoreExecutorType _Task = new EcoreExecutorType(Assignment1Package.Literals.TASK, PACKAGE, 0);
		public static final EcoreExecutorType _WhileDecision = new EcoreExecutorType(Assignment1Package.Literals.WHILE_DECISION, PACKAGE, 0);
		...
		/**
		 * Force initialization of the fields of Assignment1Tables::Types and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class Fragments {
		...
		private static final ExecutorFragment _Action__Action = new ExecutorFragment(Types._Action, Assignment1Tables.Types._Action);
		...
		private static final ExecutorFragment _ClosureBackedAction__Action = new ExecutorFragment(Types._ClosureBackedAction, Assignment1Tables.Types._Action);
		private static final ExecutorFragment _ClosureBackedAction__ClosureBackedAction = new ExecutorFragment(Types._ClosureBackedAction, Assignment1Tables.Types._ClosureBackedAction);
		...
		private static final ExecutorFragment _Condition__Condition = new ExecutorFragment(Types._Condition, Assignment1Tables.Types._Condition);
		...
		private static final ExecutorFragment _CustomAction__Action = new ExecutorFragment(Types._CustomAction, Assignment1Tables.Types._Action);
		private static final ExecutorFragment _CustomAction__CustomAction = new ExecutorFragment(Types._CustomAction, Assignment1Tables.Types._CustomAction);
		...
		private static final ExecutorFragment _Decision__Decision = new ExecutorFragment(Types._Decision, Assignment1Tables.Types._Decision);
		...
		private static final ExecutorFragment _DefaultAction__Action = new ExecutorFragment(Types._DefaultAction, Assignment1Tables.Types._Action);
		private static final ExecutorFragment _DefaultAction__DefaultAction = new ExecutorFragment(Types._DefaultAction, Assignment1Tables.Types._DefaultAction);
		...
		private static final ExecutorFragment _End__Action = new ExecutorFragment(Types._End, Assignment1Tables.Types._Action);
		private static final ExecutorFragment _End__End = new ExecutorFragment(Types._End, Assignment1Tables.Types._End);
		...
		private static final ExecutorFragment _File__File = new ExecutorFragment(Types._File, Assignment1Tables.Types._File);
		...
		private static final ExecutorFragment _FileTarget__FileTarget = new ExecutorFragment(Types._FileTarget, Assignment1Tables.Types._FileTarget);
		...
		private static final ExecutorFragment _IfDecision__Decision = new ExecutorFragment(Types._IfDecision, Assignment1Tables.Types._Decision);
		private static final ExecutorFragment _IfDecision__IfDecision = new ExecutorFragment(Types._IfDecision, Assignment1Tables.Types._IfDecision);
		...
		private static final ExecutorFragment _Instruction__Instruction = new ExecutorFragment(Types._Instruction, Assignment1Tables.Types._Instruction);
		...
		private static final ExecutorFragment _InstructionBlock__InstructionBlock = new ExecutorFragment(Types._InstructionBlock, Assignment1Tables.Types._InstructionBlock);
		...
		private static final ExecutorFragment _LoopDecision__Decision = new ExecutorFragment(Types._LoopDecision, Assignment1Tables.Types._Decision);
		private static final ExecutorFragment _LoopDecision__LoopDecision = new ExecutorFragment(Types._LoopDecision, Assignment1Tables.Types._LoopDecision);
		...
		private static final ExecutorFragment _Model__Model = new ExecutorFragment(Types._Model, Assignment1Tables.Types._Model);
		...
		private static final ExecutorFragment _Project__Project = new ExecutorFragment(Types._Project, Assignment1Tables.Types._Project);
		...
		private static final ExecutorFragment _Property__Property = new ExecutorFragment(Types._Property, Assignment1Tables.Types._Property);

		private static final ExecutorFragment _Start__Action = new ExecutorFragment(Types._Start, Assignment1Tables.Types._Action);
		...
		private static final ExecutorFragment _Start__Start = new ExecutorFragment(Types._Start, Assignment1Tables.Types._Start);
		...
		private static final ExecutorFragment _Target__Target = new ExecutorFragment(Types._Target, Assignment1Tables.Types._Target);
		...
		private static final ExecutorFragment _Task__Task = new ExecutorFragment(Types._Task, Assignment1Tables.Types._Task);

		private static final ExecutorFragment _WhileDecision__Decision = new ExecutorFragment(Types._WhileDecision, Assignment1Tables.Types._Decision);
		private static final ExecutorFragment _WhileDecision__LoopDecision = new ExecutorFragment(Types._WhileDecision, Assignment1Tables.Types._LoopDecision);
		...
		private static final ExecutorFragment _WhileDecision__WhileDecision = new ExecutorFragment(Types._WhileDecision, Assignment1Tables.Types._WhileDecision);
		...
		/**
		 * Force initialization of the fields of Assignment1Tables::Fragments and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class Parameters {
		...
		/**
		 * Force initialization of the fields of Assignment1Tables::Parameters and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class Operations {
		...
		/**
		 * Force initialization of the fields of Assignment1Tables::Operations and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class Properties {
		...
		public static final ExecutorProperty _Action__decisions = new EcoreExecutorProperty(Assignment1Package.Literals.ACTION__DECISIONS, Types._Action, 0);
		public static final ExecutorProperty _Action__has = new EcoreExecutorProperty(Assignment1Package.Literals.ACTION__HAS, Types._Action, 1);
		public static final ExecutorProperty _Action__name = new EcoreExecutorProperty(Assignment1Package.Literals.ACTION__NAME, Types._Action, 2);
		public static final ExecutorProperty _Action__Start__next = new ExecutorPropertyWithImplementation("Start", Types._Action, 3, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.START__NEXT));
		public static final ExecutorProperty _Action__Task__actions = new ExecutorPropertyWithImplementation("Task", Types._Action, 4, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.TASK__ACTIONS));

		public static final ExecutorProperty _Condition__stop_condition = new EcoreExecutorProperty(Assignment1Package.Literals.CONDITION__STOP_CONDITION, Types._Condition, 0);
		public static final ExecutorProperty _Condition__IfDecision__contains = new ExecutorPropertyWithImplementation("IfDecision", Types._Condition, 1, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.IF_DECISION__CONTAINS));

		public static final ExecutorProperty _Decision__has = new EcoreExecutorProperty(Assignment1Package.Literals.DECISION__HAS, Types._Decision, 0);
		public static final ExecutorProperty _Decision__Action__decisions = new ExecutorPropertyWithImplementation("Action", Types._Decision, 1, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.ACTION__DECISIONS));

		public static final ExecutorProperty _File__name = new EcoreExecutorProperty(Assignment1Package.Literals.FILE__NAME, Types._File, 0);
		public static final ExecutorProperty _File__FileTarget__created_towards_a_file = new ExecutorPropertyWithImplementation("FileTarget", Types._File, 1, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.FILE_TARGET__CREATED_TOWARDS_AFILE));
		public static final ExecutorProperty _File__Target__output = new ExecutorPropertyWithImplementation("Target", Types._File, 2, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.TARGET__OUTPUT));

		public static final ExecutorProperty _FileTarget__created_towards_a_file = new EcoreExecutorProperty(Assignment1Package.Literals.FILE_TARGET__CREATED_TOWARDS_AFILE, Types._FileTarget, 0);
		public static final ExecutorProperty _FileTarget__target = new EcoreExecutorProperty(Assignment1Package.Literals.FILE_TARGET__TARGET, Types._FileTarget, 1);

		public static final ExecutorProperty _IfDecision__contains = new EcoreExecutorProperty(Assignment1Package.Literals.IF_DECISION__CONTAINS, Types._IfDecision, 0);
		public static final ExecutorProperty _IfDecision__elseif = new EcoreExecutorProperty(Assignment1Package.Literals.IF_DECISION__ELSEIF, Types._IfDecision, 1);
		public static final ExecutorProperty _IfDecision__IfDecision__elseif = new ExecutorPropertyWithImplementation("IfDecision", Types._IfDecision, 2, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.IF_DECISION__ELSEIF));

		public static final ExecutorProperty _Instruction__name = new EcoreExecutorProperty(Assignment1Package.Literals.INSTRUCTION__NAME, Types._Instruction, 0);
		public static final ExecutorProperty _Instruction__InstructionBlock__has = new ExecutorPropertyWithImplementation("InstructionBlock", Types._Instruction, 1, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.INSTRUCTION_BLOCK__HAS));

		public static final ExecutorProperty _InstructionBlock__has = new EcoreExecutorProperty(Assignment1Package.Literals.INSTRUCTION_BLOCK__HAS, Types._InstructionBlock, 0);
		public static final ExecutorProperty _InstructionBlock__Action__has = new ExecutorPropertyWithImplementation("Action", Types._InstructionBlock, 1, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.ACTION__HAS));

		public static final ExecutorProperty _Model__name = new EcoreExecutorProperty(Assignment1Package.Literals.MODEL__NAME, Types._Model, 0);
		public static final ExecutorProperty _Model__project = new EcoreExecutorProperty(Assignment1Package.Literals.MODEL__PROJECT, Types._Model, 1);

		public static final ExecutorProperty _Project__name = new EcoreExecutorProperty(Assignment1Package.Literals.PROJECT__NAME, Types._Project, 0);
		public static final ExecutorProperty _Project__target = new EcoreExecutorProperty(Assignment1Package.Literals.PROJECT__TARGET, Types._Project, 1);
		public static final ExecutorProperty _Project__tasks = new EcoreExecutorProperty(Assignment1Package.Literals.PROJECT__TASKS, Types._Project, 2);
		public static final ExecutorProperty _Project__version = new EcoreExecutorProperty(Assignment1Package.Literals.PROJECT__VERSION, Types._Project, 3);
		public static final ExecutorProperty _Project__Model__project = new ExecutorPropertyWithImplementation("Model", Types._Project, 4, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.MODEL__PROJECT));

		public static final ExecutorProperty _Property__has = new EcoreExecutorProperty(Assignment1Package.Literals.PROPERTY__HAS, Types._Property, 0);
		public static final ExecutorProperty _Property__name = new EcoreExecutorProperty(Assignment1Package.Literals.PROPERTY__NAME, Types._Property, 1);
		public static final ExecutorProperty _Property__value = new EcoreExecutorProperty(Assignment1Package.Literals.PROPERTY__VALUE, Types._Property, 2);
		public static final ExecutorProperty _Property__Decision__has = new ExecutorPropertyWithImplementation("Decision", Types._Property, 3, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.DECISION__HAS));
		public static final ExecutorProperty _Property__Property__has = new ExecutorPropertyWithImplementation("Property", Types._Property, 4, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.PROPERTY__HAS));
		public static final ExecutorProperty _Property__Task__has = new ExecutorPropertyWithImplementation("Task", Types._Property, 5, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.TASK__HAS));

		public static final ExecutorProperty _Start__next = new EcoreExecutorProperty(Assignment1Package.Literals.START__NEXT, Types._Start, 0);

		public static final ExecutorProperty _Target__dependencies = new EcoreExecutorProperty(Assignment1Package.Literals.TARGET__DEPENDENCIES, Types._Target, 0);
		public static final ExecutorProperty _Target__has = new EcoreExecutorProperty(Assignment1Package.Literals.TARGET__HAS, Types._Target, 1);
		public static final ExecutorProperty _Target__output = new EcoreExecutorProperty(Assignment1Package.Literals.TARGET__OUTPUT, Types._Target, 2);
		public static final ExecutorProperty _Target__FileTarget__target = new ExecutorPropertyWithImplementation("FileTarget", Types._Target, 3, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.FILE_TARGET__TARGET));
		public static final ExecutorProperty _Target__Project__target = new ExecutorPropertyWithImplementation("Project", Types._Target, 4, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.PROJECT__TARGET));
		public static final ExecutorProperty _Target__Target__dependencies = new ExecutorPropertyWithImplementation("Target", Types._Target, 5, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.TARGET__DEPENDENCIES));

		public static final ExecutorProperty _Task__actions = new EcoreExecutorProperty(Assignment1Package.Literals.TASK__ACTIONS, Types._Task, 0);
		public static final ExecutorProperty _Task__depends = new EcoreExecutorProperty(Assignment1Package.Literals.TASK__DEPENDS, Types._Task, 1);
		public static final ExecutorProperty _Task__description = new EcoreExecutorProperty(Assignment1Package.Literals.TASK__DESCRIPTION, Types._Task, 2);
		public static final ExecutorProperty _Task__has = new EcoreExecutorProperty(Assignment1Package.Literals.TASK__HAS, Types._Task, 3);
		public static final ExecutorProperty _Task__name = new EcoreExecutorProperty(Assignment1Package.Literals.TASK__NAME, Types._Task, 4);
		public static final ExecutorProperty _Task__Project__tasks = new ExecutorPropertyWithImplementation("Project", Types._Task, 5, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.PROJECT__TASKS));
		public static final ExecutorProperty _Task__Target__has = new ExecutorPropertyWithImplementation("Target", Types._Task, 6, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.TARGET__HAS));
		public static final ExecutorProperty _Task__Task__depends = new ExecutorPropertyWithImplementation("Task", Types._Task, 7, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.TASK__DEPENDS));

		public static final ExecutorProperty _WhileDecision__Condition__stop_condition = new ExecutorPropertyWithImplementation("Condition", Types._WhileDecision, 0, new EcoreLibraryOppositeProperty(Assignment1Package.Literals.CONDITION__STOP_CONDITION));
		static {
			Init.initEnd();
		}

		/**
		 * Force initialization of the fields of Assignment1Tables::Properties and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class TypeFragments {
		...
		/**
		 * Force initialization of the fields of Assignment1Tables::TypeFragments and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class FragmentOperations {
		...
		/**
		 * Force initialization of the fields of Assignment1Tables::FragmentOperations and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class FragmentProperties {
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Action = {
			Assignment1Tables.Properties._Action__decisions,
			Assignment1Tables.Properties._Action__has,
			Assignment1Tables.Properties._Action__name,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Condition = {
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
			Assignment1Tables.Properties._Condition__stop_condition
		};
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Decision = {
			Assignment1Tables.Properties._Decision__has,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};
		...
		private static final ExecutorProperty /*@NonNull*/ [] _File = {
			Assignment1Tables.Properties._File__name,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};

		private static final ExecutorProperty /*@NonNull*/ [] _FileTarget = {
			Assignment1Tables.Properties._FileTarget__created_towards_a_file,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
			Assignment1Tables.Properties._FileTarget__target
		};

		private static final ExecutorProperty /*@NonNull*/ [] _IfDecision = {
			Assignment1Tables.Properties._IfDecision__contains,
			Assignment1Tables.Properties._IfDecision__elseif,
			Assignment1Tables.Properties._Decision__has,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Instruction = {
			Assignment1Tables.Properties._Instruction__name,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};

		private static final ExecutorProperty /*@NonNull*/ [] _InstructionBlock = {
			Assignment1Tables.Properties._InstructionBlock__has,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Model = {
			Assignment1Tables.Properties._Model__name,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
			Assignment1Tables.Properties._Model__project
		};

		private static final ExecutorProperty /*@NonNull*/ [] _Project = {
			Assignment1Tables.Properties._Project__name,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
			Assignment1Tables.Properties._Project__target,
			Assignment1Tables.Properties._Project__tasks,
			Assignment1Tables.Properties._Project__version
		};

		private static final ExecutorProperty /*@NonNull*/ [] _Property = {
			Assignment1Tables.Properties._Property__has,
			Assignment1Tables.Properties._Property__name,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
			Assignment1Tables.Properties._Property__value
		};
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Start = {
			...
			Assignment1Tables.Properties._Action__has,
			Assignment1Tables.Properties._Action__name,
			Assignment1Tables.Properties._Start__next,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};

		private static final ExecutorProperty /*@NonNull*/ [] _Target = {
			Assignment1Tables.Properties._Target__dependencies,
			Assignment1Tables.Properties._Target__has,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
			Assignment1Tables.Properties._Target__output
		};

		private static final ExecutorProperty /*@NonNull*/ [] _Task = {
			Assignment1Tables.Properties._Task__actions,
			Assignment1Tables.Properties._Task__depends,
			Assignment1Tables.Properties._Task__description,
			Assignment1Tables.Properties._Task__has,
			Assignment1Tables.Properties._Task__name,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};
		...
		/**
		 * Force initialization of the fields of Assignment1Tables::FragmentProperties and all preceding sub-packages.
		 */
		public static void init() {}
	}
	...
	public static class EnumerationLiterals {
		...
		/**
		 * Force initialization of the fields of Assignment1Tables::EnumerationLiterals and all preceding sub-packages.
		 */
		public static void init() {}
	}
	 ...
	 */
	public static void init() {
		new Assignment1Tables();
	}

	private Assignment1Tables() {
		super(Assignment1Package.eNS_URI);
	}
	...
	private static final EClass allInstancesEClasses /*@NonNull*/ [] = {
		Assignment1Package.Literals.PROPERTY,
		Assignment1Package.Literals.TASK
	};
