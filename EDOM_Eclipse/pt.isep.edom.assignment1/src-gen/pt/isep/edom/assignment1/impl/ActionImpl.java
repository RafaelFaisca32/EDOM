 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.edom.assignment1.impl.ActionImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.edom.assignment1.impl.ActionImpl#getDecisions <em>Decisions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionImpl extends MinimalEObjectImpl.Container implements Action {
	...
	protected EClass eStaticClass() {
		return Assignment1Package.Literals.ACTION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Assignment1Package.ACTION__NAME, oldName, name));
	}
	...
	public EList<Decision> getDecisions() {
		if (decisions == null) {
			decisions = new EObjectContainmentEList<Decision>(Decision.class, this,
					Assignment1Package.ACTION__DECISIONS);
		}
		return decisions;
	}
