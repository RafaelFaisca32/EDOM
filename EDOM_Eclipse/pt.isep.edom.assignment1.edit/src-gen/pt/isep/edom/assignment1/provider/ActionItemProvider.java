...
/**
 * This is the item provider adapter for a {@link pt.isep.edom.assignment1.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Assignment1Package.Literals.ACTION__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Assignment1Package.Literals.ACTION__DECISIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case Assignment1Package.ACTION__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case Assignment1Package.ACTION__DECISIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Assignment1Package.Literals.ACTION__DECISIONS,
				Assignment1Factory.eINSTANCE.createDecision()));
	}
